...
public class TodoControllerTest {
    ...
    public void testGetTodoById() {
        ...
        ResponseEntity<Todo> response = todoController.getTodoById(testId.toString());
    ...
    public void testGetTodosByUser() {
        ...
        ResponseEntity<List<Todo>> response = todoController.getTodosByUser("testUser");
    ...
    public void testUpdateTodo() {
        ...
        Todo updatedTodo = todoController.updateTodo(testId.toString(), testTodo);
    ...
    public void testDeleteTodoSuccess() {
        ...
        ResponseEntity<?> response = todoController.deleteTodo(testId.toString());
